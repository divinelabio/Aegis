...
import { WAFManagedRuleFile } from './types.js';

export function formatManagedRuleName(fileName: string): string {
...
export function managedRuleDescription(file: WAFManagedRuleFile): string {
...
export function managedRuleStatus(file: WAFManagedRuleFile): { label: string; tone: string } {
...
export function managedRulePolicyGroup(file: WAFManagedRuleFile): { key: string; label: string; description: string; tone: string } {
...
export function renderManagedPolicyRuleRow(file: WAFManagedRuleFile): string {
...
export function renderManagedPolicyGroup(
    group: { key: string; label: string; description: string; tone: string; files: WAFManagedRuleFile[] }
): string {
    return `
...
export function renderManagedRulesFolder(crsRules: WAFManagedRuleFile[], reloadFailed: boolean): string {
