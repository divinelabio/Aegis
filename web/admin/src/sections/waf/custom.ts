...
import { WAFCustomRule, WAFRuleTarget } from './types.js';

export function renderCustomRulesList(rules: WAFCustomRule[]): string {
...
export function renderRuleEditor(editingRule: WAFCustomRule | null, renderVisualBuilder: (rule: WAFCustomRule | null) => string): string {
