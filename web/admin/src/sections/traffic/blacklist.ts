...
import { TrafficBlacklistConfig, TrafficBlacklistEntry } from './types.js';

export interface TrafficBlacklistPaginationState {
    page: number;
    pageSize: number;
    search: string;
}

export function renderBlacklistTab(
    config: TrafficBlacklistConfig | undefined,
    pagination: TrafficBlacklistPaginationState,
                ...
                <div class="flow-blacklist-table-wrap">
                    <table class="flow-blacklist-table">
                        ...
                        <tbody id="blacklist-table-body">
                            ${pageEntries.length ? pageEntries.map((entry: TrafficBlacklistEntry) => {
