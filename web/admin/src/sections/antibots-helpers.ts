type AntibotBrandInfo = {
  bg: string;
  icon: string;
};

type AntibotsHelperApi = {
  escapeHTML(value: unknown): string;
  escapeAttr(value: unknown): string;
  getBotLogo(botName: string): string;
};

const ANTIBOT_BRANDS: Record<string, AntibotBrandInfo> = {
  GPTBot: {
...
export const AntibotsHelpers: AntibotsHelperApi = {
  escapeHTML(value: unknown): string {
