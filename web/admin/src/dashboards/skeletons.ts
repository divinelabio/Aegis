 ...
 */
export function renderMetricSkeleton(width = '74px', height = '28px'): string {
 ...
 */
export function renderMetricSubSkeleton(width = '96px', height = '12px'): string {
 ...
 */
export function renderTextSkeleton(width = '100%', height = '13px'): string {
 ...
 */
export function renderBadgeSkeleton(width = '52px', height = '20px'): string {
 ...
 */
export function renderChartSkeleton(barCount = 18): string {
  const heights = [
 ...
 */
export function renderBreakdownSkeleton(rowCount = 5): string {
 ...
 */
export function renderProtectionCardsSkeleton(cardCount = 4): string {
 ...
 */
export function renderTableSkeleton(columnCount = 8, rowCount = 6): string {
  const widthsByCol: Record<number, string[]> = {
 ...
 */
export function renderSystemServicesSkeleton(rowCount = 4): string {
 ...
 */
export function renderSecurityAnalyticsSkeleton(): string {
  return `
