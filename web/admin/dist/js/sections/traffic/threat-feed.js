...
export function renderThreatDirectorySection(feedData, _reputationConfig, pagination, icons) {
...
export function renderUnifiedThreatFeedPage(feedData, reputationConfig, pagination, icons, renderSaveButtons) {
    return `
