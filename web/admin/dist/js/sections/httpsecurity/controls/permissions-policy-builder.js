...
export function renderPermissionsPolicyBuilder(value) {
    const currentValue = String(value || '').trim();
    const map = parseHTTPSecurityPermissionsPolicy(value);
    const activePreset = ['baseline', 'strict', 'compatibility'].find((preset) => currentValue === applyHTTPSecurityPermissionsPreset(preset)) || '';
    const presets = [
