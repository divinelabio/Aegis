...
export function renderNumberField(label, path, value) {
...
export function renderToggleField(label, path, checked) {
...
export function renderGuardPanel(title, basePath, cfg, numbers, toggles = []) {
...
export function renderBodyExpertThreshold(body) {
    return `
...
export function renderBodyExpertGuards(body) {
    return `
