export function getAntibotBotIconChar(name) {
    ...
    if (n.includes('telegram'))
        return svgs.telegram;
    if (n.includes('slack'))
        return svgs.slack;
    if (n.includes('linkedin'))
        return svgs.linkedin;
    if (n.includes('pinterest'))
        return svgs.pinterest;
    if (n.includes('amazon'))
        return svgs.amazon;
    if (n.includes('oracle'))
        return svgs.oracle;
    if (n.includes('salesforce'))
        return svgs.salesforce;
    if (n.includes('archive'))
        return svgs.archive;
    if (n.includes('mj12'))
        return svgs.mj12;
    if (n.includes('dotbot'))
        return svgs.dotbot;
    if (n.includes('ahrefs'))
        return svgs.ahrefs;
    if (n.includes('semrush'))
        return svgs.semrush;
    if (n.includes('exabot'))
        return svgs.exabot;
    if (n.includes('seznam'))
        return svgs.seznam;
    if (n.includes('coccoc'))
        return svgs.coccoc;
    if (n.includes('petal'))
        return svgs.petal;
    if (n.includes('turnitin'))
        return svgs.turnitin;
    if (n.includes('mojeek'))
        return svgs.mojeek;
    if (n.includes('grapeshot'))
        return svgs.grapeshot;
